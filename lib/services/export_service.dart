...
class ExportService {
  ...
  static Future<void> exportToExcel({
    ...
    try {
      ...
      sheet.appendRow([
        ...
        TextCellValue('Type'),
        TextCellValue(
            'Amount (${currencySymbol == '৳' ? 'BDT' : currencySymbol})'),
      ]);
      ...
      String fileName =
          'AyBay_Report_${DateTime.now().millisecondsSinceEpoch}.xlsx';
  ...
  static Future<void> exportToPdf({
    ...
    try {
            ...
            return [
              pw.Header(
                ...
                child: pw.Row(
                    ...
                    children: [
                      pw.Text('AyBay Analytics Report',
                          style: pw.TextStyle(
      ...
      String fileName =
          'AyBay_Report_${DateTime.now().millisecondsSinceEpoch}.pdf';
      String fullPath = '$path/$fileName';
  ...
  static Future<void> exportEventToExcel({
    ...
    try {
      ...
      String fileName =
          'AyBay_Event_${eventName}_${DateTime.now().millisecondsSinceEpoch}.xlsx';
      String fullPath = '$path/$fileName';
      File(fullPath)
        ..createSync(recursive: true)
        ..writeAsBytesSync(excel.encode()!);
  ...
  static Future<void> exportEventToPdf({
    ...
    try {
            ...
            return [
              pw.Header(
                ...
                child: pw.Row(
                    mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                    children: [
                      pw.Text('Event Ledger: $eventName',
                          style: pw.TextStyle(
                              fontSize: 24, fontWeight: pw.FontWeight.bold)),
                      if (logoImage != null)
                        pw.Container(
      ...
      String fileName =
          'AyBay_Event_${eventName}_${DateTime.now().millisecondsSinceEpoch}.pdf';
      String fullPath = '$path/$fileName';
      final file = File(fullPath);
      await file.writeAsBytes(await pdf.save());
