...
class _MonthlyAnalyticsTabState extends State<MonthlyAnalyticsTab> {
  ...
  Widget build(BuildContext context) {
    ...
    final monthTxs = finProv.transactions
    ...
    List<PieChartSectionData> _buildPieSections(
        Map<String, double> data, Color baseColor) {
      if (data.isEmpty)
        return [
          PieChartSectionData(
              value: 1, color: Colors.grey.shade300, title: 'No Data')
        ];
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: PieChart(PieChartData(
                      ...
                      sections: _buildPieSections(
                          incomeByCategory, AppColors.green))),
                ),
                ...
                SizedBox(
                  ...
                  child: PieChart(PieChartData(
                      ...
                      centerSpaceRadius: 40,
                      sections:
                          _buildPieSections(expenseByCategory, AppColors.red))),
                ),
                const Padding(
