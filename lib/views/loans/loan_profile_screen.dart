...
class _LoanProfileScreenState extends State<LoanProfileScreen> {
  ...
  void _showAddInstallmentDialog(
      BuildContext context, FinanceProvider finProv) {
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if (amount > 0) {
                        ...
                        finProv.addLoanInstallment(widget.loanId, amount, date,
  ...
  Widget build(BuildContext context) {
    ...
    final isCompleted =
        loan.status == 'settled' || loan.amountPaid >= loan.amount;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor:
            loan.type == 'loan' ? const Color(0xFFD84315) : AppColors.purple,
        elevation: 0,
        leading: IconButton(
      ...
      body: Column(
        ...
        children: [
              ...
              children: [
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(CurrencyFormatter.formatSimple(loan.amount, sym),
                            style: const TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.bold,
                                color: Colors.white)),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                        CurrencyFormatter.formatSimple(
                            loan.amount - loan.amountPaid, sym),
                        style: const TextStyle(
                            fontSize: 24,
                            fontWeight: FontWeight.bold,
                            color: Colors.white)),
                ...
                children: [
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () =>
                          _showAddInstallmentDialog(context, finProv),
                    ),
                  ),
          ...
          const Padding(
            ...
            child: Text('Installment History',
                style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
          ...
          Expanded(
            child: installments.isEmpty
                ? const Center(
                    child: Text('No installments added yet.',
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final inst =
                          installments[installments.length - 1 - index];
