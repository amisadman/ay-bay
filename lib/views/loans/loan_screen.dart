...
class _LoanScreenState extends State<LoanScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final filteredLoans =
        finProv.loans.where((l) => l.type == widget.initialType).toList();

    return Scaffold(
      backgroundColor: Theme.of(context).scaffoldBackgroundColor,
      appBar: AppBar(
        backgroundColor: widget.initialType == 'loan'
                  ...
                  children: [
                    ...
                    Text(
                      CurrencyFormatter.formatSimple(
                          widget.initialType == 'loan'
                              ? finProv.totalLoanGiven
                              : finProv.totalOweBorrowed,
                          sym),
                      style: TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                        color: widget.initialType == 'loan'
                            ? const Color(0xFFD84315)
                            : AppColors.purple,
                      ),
                    ),
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final progress = loan.amount > 0
                          ? (loan.amountPaid / loan.amount).clamp(0.0, 1.0)
                          : 0.0;
                      final isCompleted =
                          loan.status == 'settled' || progress >= 1.0;
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (_) =>
                                    LoanProfileScreen(loanId: loan.id!)),
                          );
                        },
                        child: Container(
