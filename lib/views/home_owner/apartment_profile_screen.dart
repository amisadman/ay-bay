...
class _ApartmentProfileScreenState extends State<ApartmentProfileScreen> {
  ...
  Future<void> _deleteApartment() async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('Are you sure you want to delete this apartment? All records will be lost.'),
        actions: [
    ...
    if (confirm == true) {
      if (mounted) {
        Provider.of<HomeOwnerProvider>(context, listen: false).deleteApartment(_apartment.id!);
  ...
  Future<void> _generateReceipt(bool share, String monthKey) async {
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Text('RENT RECEIPT', style: pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold, decoration: pw.TextDecoration.underline)),
              ...
              pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [
                ...
                pw.Text('REC-${now.millisecondsSinceEpoch.toString().substring(8)}', style: pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold)),
              ]),
              pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [
              ...
              pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [
                pw.Text('Rent Period:', style: const pw.TextStyle(fontSize: 10)),
                pw.Text(monthName, style: pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold)),
              ]),
              ...
              pw.Align(alignment: pw.Alignment.centerLeft, child: pw.Text('Received From:', style: const pw.TextStyle(fontSize: 10))),
              pw.Align(alignment: pw.Alignment.centerLeft, child: pw.Text(_apartment.boarderName, style: pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold))),
              pw.Align(alignment: pw.Alignment.centerLeft, child: pw.Text('Ph: ${_apartment.boarderPhone}', style: const pw.TextStyle(fontSize: 10))),
              
              pw.SizedBox(height: 10),
              pw.Align(alignment: pw.Alignment.centerLeft, child: pw.Text('For Property:', style: const pw.TextStyle(fontSize: 10))),
              pw.Align(alignment: pw.Alignment.centerLeft, child: pw.Text(_apartment.name, style: pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold))),
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text('Tk. ${_apartment.rentAmount.toStringAsFixed(2)}', style: pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold)),
                ],
              ),
              ...
              pw.Text('Thank you!', style: pw.TextStyle(fontSize: 12, fontStyle: pw.FontStyle.italic)),
    ...
    if (share) {
      await Printing.sharePdf(bytes: bytes, filename: 'Receipt_${_apartment.name}_$monthName.pdf');
    } else {
  ...
  void _showReceiptOptions(String monthKey) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('Would you like to Print this receipt or Share/Download it as a PDF?'),
        actions: [
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(icon: const Icon(Icons.delete), onPressed: _deleteApartment),
        ],
      ),
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: isPaid ? AppColors.green.withValues(alpha: 0.1) : AppColors.red.withValues(alpha: 0.1),
            ...
            if (_apartment.paidMonths.isNotEmpty) ...[
              const Text('Past Receipts', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const SizedBox(height: 12),
              ..._apartment.paidMonths.map((monthKey) {
                final parts = monthKey.split('-');
                final monthNameStr = DateFormat('MMMM yyyy').format(DateTime(int.parse(parts[0]), int.parse(parts[1])));
                return Card(
                  margin: const EdgeInsets.only(bottom: 8),
                  child: ListTile(
                    leading: const Icon(Icons.receipt_long, color: AppColors.deepTeal),
                    title: Text(monthNameStr, style: const TextStyle(fontWeight: FontWeight.bold)),
