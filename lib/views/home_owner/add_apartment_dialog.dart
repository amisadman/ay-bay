...
class AddApartmentDialog extends StatefulWidget {
  ...
  @override
  State<AddApartmentDialog> createState() => _AddApartmentDialogState();
}

class _AddApartmentDialogState extends State<AddApartmentDialog> {
  final _formKey = GlobalKey<FormState>();
  final _nameController = TextEditingController();
  final _boarderNameController = TextEditingController();
  final _boarderPhoneController = TextEditingController();
  ...
  void _saveApartment() {
    if (_formKey.currentState!.validate()) {
      ...
      Provider.of<HomeOwnerProvider>(context, listen: false).addApartment(appt);
