...
class _BudgetProfileScreenState extends State<BudgetProfileScreen> {
          ...
          children: [
            TextField(
                ...
                decoration: const InputDecoration(
                    labelText: 'Category Name (e.g. Groceries)')),
            TextField(
  ...
  void _showLogExpenseDialog(BuildContext context, FinanceProvider finProv,
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setStateBuilder) => AlertDialog(
          title: Text('Log Expense: $catName',
          ...
          content: Column(
            ...
            children: [
              ...
              SwitchListTile(
                title: const Text('Log as Global Expense',
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                final amt = double.tryParse(amountCtrl.text.trim()) ?? 0.0;
                if (amt > 0) {
                  finProv.logBudgetExpense(widget.budgetId, catId, amt,
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(CurrencyFormatter.formatSimple(totalAllocated, sym),
                        style: const TextStyle(
                            fontSize: 24,
                            fontWeight: FontWeight.bold,
                            color: Colors.white)),
                ...
                Column(
                  ...
                  children: [
                    const Text('Total Spent',
                        style: TextStyle(color: Colors.white70)),
                    const SizedBox(height: 4),
                    Text(CurrencyFormatter.formatSimple(totalSpent, sym),
                        style: TextStyle(
                            fontSize: 24,
                            fontWeight: FontWeight.bold,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                    'Spent: ${CurrencyFormatter.formatSimple(spent, sym)}',
