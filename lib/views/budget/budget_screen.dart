  ...
  void _showAddMonthDialog() {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: const Text('New Budget Profile',
            style:
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: finProv.budgets.isEmpty
          ? const Center(
              child: Text('No budget profiles found.',
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (_) =>
                              BudgetProfileScreen(budgetId: budget.id!)),
                    );
                  },
                  child: Container(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                                'Allocated: ${CurrencyFormatter.formatSimple(totalAllocated, sym)}',
                                style: const TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.bold,
